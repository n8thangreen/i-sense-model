...
save(scenario1, file = "../../data cleaned/scenario1_costeffective.csv")
...
save(scenario2a, file = "../../data cleaned/scenario2a_costeffective.csv")
...
save(scenario2b, file = "../../data cleaned/scenario2b_costeffective.csv")
...
save(scenario2c, file = "../../data cleaned/scenario2c_costeffective.csv")


# scenario 2d (test @ NPFS only AND NPFS use increase) -----------------------------------------
## assume same prop who already seek care

##TODO: double but all go to NPFS
...
save(scenario2d, file = "../../data cleaned/scenario2d_costeffective.csv")
